angular.module('location_and_include', ['ui.bootstrap'])
    ...
    .controller('NavigationCtrl', function ($scope, $location, Menus) {
        ...
        var routes = {
            '/admin/menus/list': {templateUrl: 'router/tpls/menus/list.html'},
            '/admin/menus/new': {templateUrl: 'router_style/tpls/menus/new.html'},
            '/admin/menus/view': {templateUrl: 'router_style/tpls/menus/view.html'},
            '/admin/menus/edit': {templateUrl: 'router_style/tpls/menus/edit.html'}
        };
        $location.path('/admin/menus/list');
        var defaultRoute = routes['/admin/menus/list'];
